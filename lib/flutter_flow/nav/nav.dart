...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/searchGroup',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SearchGroup')
              : SearchGroupWidget(),
        ),
        FFRoute(
          name: 'ProfilePage',
        ...
        FFRoute(
          name: 'NotifictionsPage',
          path: '/notifictionsPage',
          builder: (context, params) => NotifictionsPageWidget(),
        ),
        FFRoute(
          name: 'AccountPage',
          path: '/accountPage',
        ...
        FFRoute(
          name: 'SelectFriends',
          path: '/selectFriends',
          builder: (context, params) => SelectFriendsWidget(),
        ),
        FFRoute(
          name: 'HelpPage',
          path: '/helpPage',
